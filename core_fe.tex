...
\small{\item{
\textbf{Frontend Core}: JavaScript (ES6+), \textbf{TypeScript}, \textbf{React.js}, Next.js (SSR, SSG, ISR, RSC), Redux, HTML5, CSS3, Tailwind CSS, Material UI, Responsive Design, Accessibility \textbf{WCAG}, Cross-browser Compatibility, Performance Optimization. - 
\textbf{Testing}: Jest, React Testing Library, Cypress, Playwright \\
\textbf{Tooling/DevOps}: Git, CI/CD, Webpack, Vite, Babel, Docker, AWS (basic deployment), Google Cloud
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implemented accessibility features (TTS, multi-voice support) in Ollama Chat app and reusable React components, improving usability and code maintainability}
