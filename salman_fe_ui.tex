...
\textbf{Frontend}: React.js, Next.js, Redux, Material-UI, Tailwind CSS, React Testing Library, LWC \\
\textbf{Backend}: Node.js, Express, GraphQL, Prisma ORM, REST APIs \\
\textbf{Cloud/DevOps}:AWS, Google Cloud Platfomr, Docker, Git version control \\
\textbf{Testing}: Jest, Agile/Scrum \\

\textbf{Tools}: Electron.js, Salesforce Service/Health Cloud
}}
\end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Accellor}{Hyd, India}
      \resumeItemListStart
        \resumeItem{Built dynamic portals and dashboards for a leading semiconductor client using React.js, Next.js, and Salesforce Experience Cloud, improving partner onboarding and engagement.}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Enhanced a desktop AI chat tool by implementing Text-to-Speech (TTS) functionality with autoplay and multi-voice options, improving accessibility and user interaction experience.}
        \resumeItem{Implemented advanced sorting and searching functionality to enhance content discoverability, and developed a dynamic documentation section using Prismic CMS integrated with Next.js for better content management.}
      \resumeItemListEnd
