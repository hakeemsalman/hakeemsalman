...
\textbf{Frontend}: React.js, Next.js (SSR, SSG, ISR, RSC), Redux, Material-UI, Tailwind CSS, LWC, React Query, Figma UX \\
\textbf{Backend}: Node.js, Express, REST APIs, GraphQL, Prisma ORM, WebSocket, RabbitMQ \\ 
\textbf{Testing}: Jest, React Testing Library, Playwright, Cypress, Methodologies: Agile/Scrum\\
\textbf{Cloud/DevOps}:AWS, Google Cloud Platfomr, Docker, Git version control, performance optimization \\
\textbf{Browser Performance}: Deep understanding of browser rendering and cross-browser compatibility
 \\
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Collaborated with cross-functional teams to optimize system performance, applying data structures and algorithms (DSA) for faster API responses and UI rendering efficiency.}
      \resumeItemListEnd
    \resumeSubheading
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Enhanced a desktop AI chat tool (Ollama + LLaVA) by implementing Text-to-Speech (TTS) with autoplay and multi-voice support. Enhanced accessibility and maintainability by applying design patterns and building reusable components.}
        ...
        \resumeItem{Built a Next.js + Prismic CMS documentation portal with component-driven architecture and SEO-friendly SSR, improving discoverability. Ensured cross-browser compatibility, accessibility (a11y), and performance optimization across features.}
      \resumeItemListEnd
