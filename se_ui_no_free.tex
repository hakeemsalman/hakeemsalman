...
\begin{center}
    ...
    $|$ \href{https://hakeemsalman.vercel.app}{\underline{hakeemsalman.dev}}
\end{center}
...
\textbf{Technologies}: Git version control, Google Cloud Platform (GCP), AWS, Docker, GraphQL \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Software Engineer 2 - UI}{Sept 2022 -- Present}
      {Accellor}{Hyd, India}
      \resumeItemListStart
